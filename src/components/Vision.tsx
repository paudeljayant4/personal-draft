  ...
  return (
    ...
    >
      <div className="absolute inset-0">
        ...
        {/* Complementary harmony pattern - gold + indigo */}
        <div className="absolute inset-0 gold-complement-pattern opacity-18" />

        {/* COMPLEMENTARY color theory radial overlay - gold next to indigo */}
        ...
        {/* Concentric enso circles - complementary gold + indigo */}
        ...
        {/* Complementary gold + indigo glows - the striking contrast */}
      ...
      <div ref={ref} className="reveal relative z-10 max-w-4xl mx-auto text-center">
        ...
        <div className="mt-24 space-y-12 max-w-xl mx-auto">
          {lines.map((line, i) => (
            ...
            >
              <span className="font-jp text-gold/65 mr-4 text-lg [text-shadow:_0_0_20px_hsl(var(--gold)/0.3)]">{line.jp}</span>
              {line.text}
            </p>
          ))}
        </div>

        <div className="mt-28 font-jp text-2xl text-gold/45 dark:text-gold/35 tracking-[0.6em] [text-shadow:_0_0_25px_hsl(var(--gold)/0.2)]">
          自由
        </div>
