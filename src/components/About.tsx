        ...
        <div ref={ref} className="reveal">
          <div className="grid md:grid-cols-12 gap-8 md:gap-16 items-start">
            ...
            <div className="md:col-span-3 md:sticky md:top-32">
              ...
              <div className="mt-8 font-jp text-3xl text-beni/30 dark:text-beni/20">
                人
              </div>
              <div className="mt-4 text-[10px] uppercase tracking-[0.2em] text-kuro/40 dark:text-shiro/40 font-mono">
                Person / Hito
              </div>
            </div>
