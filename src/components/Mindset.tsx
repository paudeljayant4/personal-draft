  ...
  return (
    <section className="relative px-6 py-40 md:py-56 overflow-hidden">
      <div className="absolute inset-0">
        ...
        {/* NEW: Color theory background art */}
        <div className="absolute inset-0 gold-triadic-pattern opacity-6" />
        <div className="absolute inset-0 color-theory-overlay" />
        
        <div className="glow-ambient glow-gold w-[600px] h-[400px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-18 animate-breathe-soft" />
        ...
        <div ref={ref} className="reveal">
          <div className="text-center">
            ...
            <blockquote className="font-display text-3xl md:text-5xl lg:text-6xl font-light tracking-[-0.04em] text-kuro/95 dark:text-shiro/95 leading-[1.15] text-balance px-6">
              <span className="text-gold/40 font-mincho text-5xl md:text-7xl align-top">"</span>
              The world doesn't wait for excuses.
              <br className="hidden md:block" />
              <span className="text-kuro/65 dark:text-shiro/65">It only sees results.</span>
              <span className="text-gold/40 font-mincho text-5xl md:text-7xl align-bottom">"</span>
            </blockquote>
